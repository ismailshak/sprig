...
func routes(d Dependencies) []route {
	...
	base := []route{
		...
		{pattern: "GET " + remindLaterPath, handler: http.HandlerFunc(todayHandler.showRemindLater)},
		{pattern: "POST " + remindLaterPath, handler: http.HandlerFunc(todayHandler.setReminder)},
		{pattern: "POST " + removeReminderPath, handler: http.HandlerFunc(todayHandler.removeReminder)},
